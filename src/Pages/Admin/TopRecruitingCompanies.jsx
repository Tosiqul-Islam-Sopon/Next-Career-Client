...
import { FaBriefcase, FaArrowLeft, FaDownload, FaBuilding, FaChartLine } from "react-icons/fa"
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Top Recruiting Companies</h1>
              <p className="text-sm text-gray-500">Analysis of the most active hiring companies</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-800 mb-1">No Company Data Available</h3>
              <p className="text-gray-500">There are currently no recruiting companies to display.</p>
            </div>
          ) : (
            <div className="p-6">
              {/* Companies grid */}
                  ...
                  >
                    ...
                    <div className="p-6">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 line-clamp-1">{company._id}</h3>
                          <div className="mt-1 flex items-center">
                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                              {company.totalRecruited} {company.totalRecruited === 1 ? "hire" : "hires"}
                            </span>
                          </div>
                        </div>
                      </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                ...
                <div className="bg-green-50 border border-green-100 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-green-800">Recruitment Insights</h3>
                      <div className="mt-2 text-sm text-green-700">
                        <p>
                          {companies[0] && companies[0]._id} leads with {companies[0] && companies[0].totalRecruited}{" "}
                          hires, showing strong growth. Consider developing strategic partnerships with these top
                          companies to enhance placement opportunities.
                        </p>
                      </div>
                    </div>
                  </div>
