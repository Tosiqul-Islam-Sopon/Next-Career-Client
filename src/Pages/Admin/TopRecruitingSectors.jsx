...
const TopRecruitingSectors = () => {
  ...
  const maxRecruited = sectors.length > 0 ? Math.max(...sectors.map((s) => s.totalRecruited)) : 0
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Top Recruiting Sectors</h1>
              <p className="text-sm text-gray-500">Analysis of the most active industry sectors</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          {isLoading ? (
            <div className="p-8 flex flex-col items-center justify-center">
              ...
              <p className="text-gray-500 font-medium">Loading sector data...</p>
            </div>
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500">There is no sector data to display at this time.</p>
            </div>
          ) : (
            <div className="p-6">
              {/* Sectors list */}
              <div className="space-y-6">
                {sectors.map((sector, index) => {
                  const percentage = (sector.totalRecruited / maxRecruited) * 100
                  return (
                    <div key={index} className="relative">
                      <div className="flex items-center mb-2">
                        ...
                        <div className="ml-4">
                          <h3 className="text-lg font-semibold text-gray-900">{sector._id}</h3>
                          <div className="flex items-center gap-2">
                            <span className="text-sm font-medium text-gray-700">{sector.totalRecruited} hires</span>
                            {index === 0 && (
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                ...
                <div className="bg-purple-50 border border-purple-100 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-purple-800">Sector Growth Analysis</h3>
                      <div className="mt-2 text-sm text-purple-700">
                        <p>
                          {sectors[0] && sectors[0]._id} is currently the leading sector with{" "}
                          {sectors[0] && sectors[0].totalRecruited} hires, showing a strong demand in the market.
                          Consider focusing resources on expanding opportunities in this sector.
                        </p>
                      </div>
                    </div>
                  </div>
