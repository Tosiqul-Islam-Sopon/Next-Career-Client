    ...
    <div className="container mx-auto mt-28 mb-8 px-4 md:px-12">
      <div className="bg-white shadow-md rounded-lg p-6">
        <div className="flex mb-6">
          <img
            src={recruitmentImageUrl}
            alt={jobTitle}
            className="w-24 h-24 rounded-lg shadow-md mr-6"
          />
          <div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700 mb-4">{jobRequirements}</p>
        </div>

        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3">Qualifications</h2>
          <p className="text-gray-700 mb-4">{jobQualifications}</p>
        </div>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 mb-4">
            ...
            <li>Type: {jobType}</li>
            <li>
              Location: {jobLocation === "Remote" ? jobLocation : onSitePlace}
            </li>
        ...
        <Link to={`/editJob/${jobId}`}>
          <div className="flex justify-center mt-8">
            <button className="bg-green-500 text-white font-semibold py-2 px-8 rounded-lg shadow-md hover:bg-green-600 transition duration-300">
              Edit
            </button>
          </div>
        </Link>
