...
import { MdArrowBack, MdArrowForward, MdWorkOutline, MdStarOutline } from "react-icons/md"
...
const FeaturedJobs = () => {
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: ["featuredJobs", page],
    queryFn: async () => {
      const response = await axiosBase.get(`/jobs/featuredJobs?page=${page}&limit=10`)
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-6">
            <div>
              <div className="flex items-center mb-2">
                <h1 className="text-3xl font-bold text-gray-900">Featured Job Opportunities</h1>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-gray-600 font-medium">Loading featured jobs...</p>
          </div>
        ) : jobs.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            <MdWorkOutline className="w-16 h-16 mx-auto text-gray-300 mb-4" />
            <h3 className="text-xl font-semibold text-gray-800 mb-2">No featured jobs found</h3>
            <p className="text-gray-600">We couldn&apos;t find any featured job listings at this time.</p>
          </div>
        ) : (
          <>
