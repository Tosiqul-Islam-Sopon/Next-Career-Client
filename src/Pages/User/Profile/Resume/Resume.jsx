...
// import ResumeViewer from '../../../PDFViewerAndUploader/ResumeViewer';
...
//     const { data: resumes = null } = useQuery({
//         queryKey: ['user', userInfo?._id],
//         queryFn: async () => {
//             const response = await axiosBase.get(`/resume/${userInfo?._id}`);
//             return [response.data];
//         },
//     });
...
//         try {
//             const response = await axiosBase.post(`/uploadResume/${userInfo._id}`, formData, {
//                 headers: {
...
//             <ResumeViewer resumes={resumes} ></ResumeViewer>
//                 <div className="mb-4">
//                     <input type="file" accept='application/pdf' onChange={handleFileChange} className="file-input file-input-bordered w-full max-w-xl" />
//                     <button
//                         type="button"
//                         className="ml-4 py-3 px-4 bg-gray-700 text-white font-bold rounded-md hover:bg-black disabled:cursor-not-allowed disabled:opacity-50"
